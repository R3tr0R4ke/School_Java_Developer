...
public class accountMetodi 
{
    //Dichiaro gli array list che conterrannò i dati utente
    public static ArrayList<String> nomeList = new ArrayList<>();
    public static ArrayList<String> cognomeList = new ArrayList<>();
    public static ArrayList<Integer> etaList = new ArrayList<>();
    ...
    public static Scanner myRicerca = new Scanner(System.in);
    public static Scanner myPassword = new Scanner(System.in);
    public static Scanner myModificaDato = new Scanner(System.in);
